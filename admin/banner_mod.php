...
?>
    ...
    <div id="principal">
    	<form class="form" name="formBanner" id="formBanner" method="post" action="<?php echo $action; ?>">
            <div id="informacaoBanner" class="content">
                ...
                <div class="box_ip" style='width:30%;'>
                    ...
                    <div class="box_sel" style='width:100%;margin-left:0;'>
                        ...
                        <div class="box_sel_d" style='width:99%;'>
                            <select name="dinamico" id="dinamico" class='required'>
                                <option></option>
                ...
                <div class='bannerDinamico' <?= ((!$banner['dinamico']) ? 'style="display:none;"' : ''); ?>>
                    <div class="box_ip">
                      ...
                      <input type="text" name="subtitulo" id="subtitulo" size="30" maxlength="100" value="<?= $banner['subtitulo']; ?>"/>
                    </div>
                    <div class="box_ip">
            ...
            <input type="hidden" id="banner_full" name="banner_full" value="<?= $banner['banner_full'] ?>" class='required'/>
            <input type="hidden" id="banner_mobile" name="banner_mobile" value="<?= $banner['banner_mobile'] ?>"  class='required'/>
