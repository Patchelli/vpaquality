...
switch ($opx) {
	...
	case ALTERA_ORDEM_CIMA:
		...
		try {
			...
			// 	 	$featuresAux = $featuresAux[0];
			// 	 	$ordemAux = $featuresAux['ordem'];
			// 	 }
			// }

			// if(!empty($featuresAux)){

			// 	$featuresAux['ordem'] = $features['ordem'];
			// 	$features['ordem'] = $ordemAux;

			// 	editOrdemFeatures($features);
			// 	editOrdemFeatures($featuresAux);
			//  }
