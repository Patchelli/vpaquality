		...
		while ($r = mysqli_fetch_assoc($query)){
			$r = array_map('utf8_encode', $r);
                if (!array_key_exists('totalRecords',$dados)){
					...
					//$r["status_icone"] = "<img src='images/estrela".($r["status"]=='1' ? "sim":"nao").".png' class='icone' onclick='inverteStatus(".$r['idbanner'].",".$r['status'].", ".'"banner"'.", function (retorno){dataTableBanner();})' width='20px' />";
