        ...
        <div id="tudo">
            <div class="login" id="login">
                ...
                <form class="login_inner bg2" action="usuario_script.php?opx=login" method="post">
                    <div class="login_inner_tit"><img src="images/set_login.png" height="7" width="13" alt="ico" />Sistema de Gestão VPA</div>
            ...
            <small>Desenvolvido por <a href="" target="_blank">Fala Mais Coda </a></small>
        </div>
    </body>
