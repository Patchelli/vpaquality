...
<![endif]-->
	<div class="box_main">
		...
		<ul class="migalha">
			<li class="migalha_home"><a href="<?=ENDERECO?>" target='_blank'><img src="" height="14" width="18" alt="ico" /></a></li>
			<li class="migalha_li"><a href=""><?php echo isset($_GET['mod']) ?  ucwords(str_replace("_"," ",$_GET['mod'])) : 'Home'?></a></li>
			<?php if(isset($_GET['acao'])){?>
				<li class="migalha_set"><img src="" height="8" width="7" alt="ico" /></li>
    ...
    <footer class="<?=(!isset($_SESSION['lateral']) || $_SESSION['lateral'] == "open" ? "" : 'footer_small' );?>">
    	<small>Copyright © <?php echo date('Y');?> Fala Mais Coda. Todos os direitos Reservado.</small>
